...
export function AdminShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen bg-[#f0f4f2]">
      <aside className="sticky top-0 flex h-screen w-60 shrink-0 flex-col border-r border-[var(--card-border)] bg-[var(--primary)] text-white">
        ...
        >
          <Link
            href="/admin/quotes"
            className="block rounded-[var(--radius-md)] px-3 py-2.5 text-sm font-medium text-white/90 hover:bg-white/10"
          >
            All quotes
          </Link>
        </nav>
